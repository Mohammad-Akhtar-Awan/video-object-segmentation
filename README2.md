...
Below are representative visual outputs from the pipeline (overlay and mask images), and links to the generated segmented videos. Open the MP4 files to play the full segmented sequence.

- City-Ride (overlay / mask):

    ![city-ride overlay](davis_vos_results/sample_frames/city-ride/00_overlay.png)
    ![city-ride mask](davis_vos_results/sample_frames/city-ride/00_mask.png)

    <!-- GIF preview -->
    <p>
    <img src="davis_vos_results/reports/gifs/city-ride_preview.gif" alt="city-ride preview GIF" style="max-width:800px;" />
    </p>

- Baseball (overlay / mask):

    ![baseball overlay](davis_vos_results/sample_frames/baseball/00_overlay.png)
    ![baseball mask](davis_vos_results/sample_frames/baseball/00_mask.png)

    <!-- GIF preview -->
    <p>
    <img src="davis_vos_results/reports/gifs/baseball_preview.gif" alt="baseball preview GIF" style="max-width:800px;" />
    </p>

- Crafting (overlay / mask):

    ![crafting overlay](davis_vos_results/sample_frames/crafting/00_overlay.png)
    ![crafting mask](davis_vos_results/sample_frames/crafting/00_mask.png)

    <!-- GIF preview -->
    <p>
    <img src="davis_vos_results/reports/gifs/crafting_preview.gif" alt="crafting preview GIF" style="max-width:800px;" />
    </p>

Segmented videos (playable MP4s):

- `davis_vos_results/segmented_videos/city-ride_segmentation.mp4`
- `davis_vos_results/segmented_videos/baseball_segmentation.mp4`
- `davis_vos_results/segmented_videos/crafting_segmentation.mp4`

You can open these directly from PowerShell:

```powershell
start davis_vos_results\segmented_videos\city-ride_segmentation.mp4
```
